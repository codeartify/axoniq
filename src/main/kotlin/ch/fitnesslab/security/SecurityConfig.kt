...
class SecurityConfig {
    ...
    fun jwtAuthenticationConverter(): JwtAuthenticationConverter {
        ...
        jwtAuthenticationConverter.setJwtGrantedAuthoritiesConverter { jwt ->
            ...
            roles
                ...
                .map { role -> org.springframework.security.core.authority.SimpleGrantedAuthority("ROLE_$role") }
        }
     ...
     */
    @Bean
    fun rateLimitingFilter(): OncePerRequestFilter = object : OncePerRequestFilter() {
        ...
        override fun doFilterInternal(
            ...
            val state = clients.compute(clientId) { _, existing ->
