...
class BexioInvoiceService(
    ...
    fun createInvoiceInBexio(
        ...
        val bexioContactId = customer.bexioContactId
        ...
        val request = BexioCreateInvoiceRequest(
    ...
    fun fetchAllInvoices(): List<BexioInvoiceDto> {
        return bexioClient.fetchInvoices()
    }
    ...
    fun fetchInvoiceById(bexioInvoiceId: Int): BexioInvoiceDto? {
        return bexioClient.fetchInvoiceById(bexioInvoiceId)
    }

    fun mapBexioStatusToInvoiceStatus(kbItemStatusId: Int): InvoiceStatus {
        return when (kbItemStatusId) {
